        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
            <div className="relative mb-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a
                        href="#"
                        className="bg-primary-green text-black font-bold px-8 py-4 rounded-full hover:bg-white transition-all hover:scale-105 shadow-[0_0_20px_rgba(0,255,148,0.2)] flex items-center gap-2 group"
                    >
                        View My Work
